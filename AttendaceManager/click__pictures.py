...
#
#
# my_img = tkinter.PhotoImage(file="C:\\Users\\Abhinav\\Downloads\\opencv-master\\opencv-master\\samples\\data\\rubberwhale2.png")
...
na = action()
print(na)
path = 'C:\\Users\\Abhinav\\Desktop\\AttendaceManager\\Images\\'
os.chdir(path)
new = na
os.mkdir(new)
...
while True:
    ...
    cv2.imshow("Image", img)
    if cv2.waitKey(1) & 0xFF == ord('s'):
        cv2.imwrite("C:/Users/Abhinav/Desktop/AttendaceManager/Images/" + new + "/" + str(count) + ".jpg", img)
        cv2.rectangle(img, (0, 200), (640, 300), (0, 255, 0), cv2.FILLED)
        cv2.putText(img, "Scan Saved", (150, 265), cv2.FONT_HERSHEY_DUPLEX, 2, (255, 255, 0), 2)
        cv2.imshow("Image", img)
        cv2.waitKey(500)
